...
public class RenewableTargetInvestmentRoleTest {
    ...
    public void setUp() throws Exception {
        ...
        // still to add locations!!!
        PowerPlant windTurbineA1 = new PowerPlant();
        windTurbineA1.specifyAndPersist(-3, energyProducer1, powerGridNodeA, wind, null);

        PowerPlant windTurbineA2 = new PowerPlant();
        windTurbineA2.specifyAndPersist(-4, energyProducer2, powerGridNodeA, wind, null);

        PowerPlant windTurbineB1 = new PowerPlant();
        windTurbineB1.specifyAndPersist(-5, energyProducer1, powerGridNodeB, wind, null);

        PowerPlant windTurbineB2 = new PowerPlant();
        windTurbineB2.specifyAndPersist(-10, energyProducer2, powerGridNodeB, wind, null);

        PowerPlant pvA1 = new PowerPlant();
        pvA1.specifyAndPersist(-2, energyProducer1, powerGridNodeA, pv, null);

        PowerPlant pvA2 = new PowerPlant();
        pvA2.specifyAndPersist(-3, energyProducer2, powerGridNodeA, pv, null);

        PowerPlant pvB1 = new PowerPlant();
        pvB1.specifyAndPersist(-5, energyProducer1, powerGridNodeB, pv, null);

        PowerPlant pvB2 = new PowerPlant();
        pvB2.specifyAndPersist(-10, energyProducer2, powerGridNodeB, pv, null);
