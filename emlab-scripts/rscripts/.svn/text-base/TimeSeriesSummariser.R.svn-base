## Adapted from: http://wiki.stdout.org/rcookbook/Graphs/, added upper and lower quartiles
## Summarizes data.
...
summarySE <- function(data=NULL, measurevar, groupvars=NULL, na.rm=FALSE,
  ...
  datac <- ddply(data, groupvars, .drop=.drop,
                 .fun= function(xx, col, na.rm) {
                   c( N    = length2(xx[,col], na.rm=na.rm),
                      ...
                      median = quantile(xx[,col], na.rm=na.rm)[3],
  ...
  datac <- rename(datac, c("mean"=measurevar, "uq.75%"="uq","lq.25%"="lq", "median.50%"="median"))
