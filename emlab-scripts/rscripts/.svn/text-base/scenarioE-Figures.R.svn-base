...
scriptFolder="/home/joern/d13n/rscripts"
outPutFolder="/home/joern/Desktop/outputD13n"
...
dfNLMinWInt<-getDataFrameForModelRun(outPutFolder, "d13nRe5NLMinWInt1", "Price Floor in A")
...
#dfNoMin100<-selectFirstXRunIdsFromDataFrame(dfNoMin, 100)
#rm(dfNoMin)
#dfDEMin100<-selectFirstXRunIdsFromDataFrame(dfDEMin, 100)
#rm(dfDEMin)
#dfNLMin100<-selectFirstXRunIdsFromDataFrame(dfNLMin, 100)
#rm(dfNLMin)
dfNoMinWInt100<-selectFirstXRunIdsFromDataFrameAndCheckForLength(dfNoMinWInt, 75, 41)
rm(dfNoMinWInt)
...
setwd('/home/joern/Desktop/figures/')
...
bigDF<-sqldf("select * from dfNLMinWInt100 union select * from dfDEMinWInt100 union select * from dfNoMinWInt100 union select * from dfAllMinWInt100 union select * from dfAllTaxNoCAT100")# union select * from dfEUMinWInt100")  
